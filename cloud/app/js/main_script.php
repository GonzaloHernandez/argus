...
function reloadData(){
  ...
  var url = 'http://www.argusingenieria.com/frozen/ws/reporter.php?request='+current_device['id_dispositivo']+';1'+';'+current_variable;
  //console.log(url);
  $.ajax({
      url : url,
      dataType : 'json',
  ...
  //RTT id variable 7
  url = 'http://www.argusingenieria.com/frozen/ws/reporter.php?request='+current_device['id_dispositivo']+';1'+';'+'7';
  $.ajax({
      url : url,
      dataType : 'json',
      success : function (info) { 
  ...
  url = 'http://www.argusingenieria.com/frozen/ws/reporter.php?request='+current_device['id_dispositivo']+';1'+';'+'12';
  $.ajax({
      url : url,
      dataType : 'json',
      success : function (info) { 
  ...
  url = 'http://www.argusingenieria.com/frozen/ws/reporter.php?request='+current_device['id_dispositivo']+';1'+';'+'13';
  $.ajax({
      url : url,
      dataType : 'json',
      success : function (info) { 
  ...
  url = 'http://www.argusingenieria.com/frozen/ws/reporter.php?request='+current_device['id_dispositivo']+';1'+';'+'14';
  $.ajax({
      url : url,
      dataType : 'json',
      success : function (info) { 
