...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href="#" onclick="about(); return false;">
            <i class="fa fa-user-secret"></i> <span>Acerca de...</a></span>
          </a>
        </li>
      </ul>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-2 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Conectividad (RTT)</span>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2021 <a href="http://argusingenieria.com">Argus Ingeniería</a>.</strong> Todos los derechos reservados
  </footer>
  <!-- ****************** -->
